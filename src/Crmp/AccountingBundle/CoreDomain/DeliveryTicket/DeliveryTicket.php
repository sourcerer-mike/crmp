...
class DeliveryTicket
{
     ...
     * Related invoice
     *
     * Each ticket should be handled with some invoice.
     * It does not force the invoice to print this delivery ticket
     * but it shows up that it is payed using the invoice.
     *
     * @var Invoice
     */
    protected $invoice;
